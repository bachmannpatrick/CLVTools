...
fct.testthat.correctness.correct.coefs.se(method = pnbd,
                                          cdnow = cdnow,
...
fct.testthat.correctness.same.as.btyd(clvtools.method = pnbd,
...
fct.testthat.correctness.same.predicting.fitting(method = pnbd,
                                                 clv.cdnow = clv.cdnow)

fct.testthat.correctness.fitting.sample.predicting.full.data.equal(method = pnbd,
                                                                   cdnow = cdnow,
                                                                   clv.cdnow = clv.cdnow)
...
fct.testthat.correctness.sorted.covariates(method = pnbd,
...
fct.testthat.correctness.staticcov.predicting.fitting(p.static = p.static,
...
fct.testthat.correctness.regularization.lambda.0.no.regularization(method = pnbd,
                                                                   clv.apparel.staticcov = clv.apparel.staticcov,
                                                                   p.static = p.static)

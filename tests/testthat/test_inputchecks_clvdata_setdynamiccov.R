...
test_that("Fails for missing/NA/NULL", {
  expect_error(SetDynamicCovariates(clv.data = ,
                                   data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", c("High.Season", "Gender", "Channel")),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", c("High.Season", "Gender", "Channel"))))
...
test_that("Fails if not clv.data input", {
  ...
  expect_error(SetDynamicCovariates(clv.data = apparelTrans,
                                   data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
...
test_that("Fails if already has covariates", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel.staticcov,
                                   data.cov.life  = apparelStaticCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelStaticCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "Cannot set")

  expect_silent(clv.data.apparel.dyncov <-
                  SetDynamicCovariates(clv.data = clv.data.apparel,
                                      data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender"),
                                      data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender"),
                                      name.date = "Cov.Date"))
...
test_that("Fails if missing/NULL/NA", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life  = , names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "missing")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = NULL, names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = NA, names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
})
...
test_that("Fails if not data.frame/data.table", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life  = as.list(apparelDynCov), names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
})
...
test_that("Fails if empty", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life  = data.frame(), names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "empty")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life  = data.frame(Id=character(), Gender=character()), names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "empty")
})
...
test_that("Fails if covariate data is to short for all customers",{
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov.tooshort, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
...
test_that("Fails if does not have covariates for all customers", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov.1missing, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "Every Id")
})
...
test_that("Fails if duplicate covariate (Id/Date)", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov.duplicate.same, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "need to have the same number")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov.duplicate.diff, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "need to have the same number")
})
...
test_that("Fails if any NA in cov data - Id", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life  = apparelDemo.1na, names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "any NA")
})
...
test_that("Fails for variable with single category", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov.1cat,  names.cov.life  = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov,       names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
...
test_that("Fails if missing/NULL/NA", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = , names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "missing")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = NULL, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = NA, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
})
...
test_that("Fails if not dataframe/datetable", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = as.list(apparelDynCov), names.cov.trans = cc("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "type data.frame or data.table")
})
...
test_that("Fails if empty", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = data.frame(), names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "empty")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
...
test_that("Fails if covariate data is to short for all customers",{
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov.tooshort, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "covariate data exactly from")
})
...
test_that("Fails if does not have covariates for all customers", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDemo.1missing, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "Every Id")
})
...
test_that("Fails if duplicate covariate (Id/Date)", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov.duplicate.same, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "need to have the same number")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov.duplicate.diff, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "need to have the same number")
})
...
test_that("Fails if any NA in cov data - Id", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDemo.1na, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "any NA")
})
...
test_that("Fails for variable with single category", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life  = apparelDynCov,     names.cov.life  = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov.1cat,names.cov.trans = c("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "variables with only a single category")
})
...
test_that("Fails if not character vector",{
  # ** Fails properly
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = list(c("High.Season", "Gender", "Channel")),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "character")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = data.frame(c("High.Season", "Gender", "Channel")),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "character")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
...
test_that("Fails if contains NA", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
               ...
               regexp = "any NA")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel", NA_character_),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "any NA")
})
...
test_that("Fails if names not in data", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "ChannelBender"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
               regexp = "could not be found in the Lifetime covariate")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "ChannelBender"),
                                   name.date = "Cov.Date"),
...
test_that("Fails if has duplicate names", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                   data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel", "Channel"),
                                   data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel"),
                                   name.date = "Cov.Date"),
...
test_that("Fails if not character vector",{
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = list("High.Season", "Gender", "Channel"),
                                    name.date = "Cov.Date"),
               regexp = "character")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = data.frame(c("High.Season", "Gender", "Channel")),
                                    name.date = "Cov.Date"),
               regexp = "character")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
...
test_that("Fails if contains NA", {
  ...
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel", NA_character_),
                                    name.date = "Cov.Date"),
               regexp = "any NA")
})
...
test_that("Fails if names not in data", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "GenderBender"),
                                    name.date = "Cov.Date"),
               regexp = "GenderBender could not be found in the Transaction covariate data")
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gend", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gend", "Channel"),
                                    name.date = "Cov.Date"),
...
test_that("Fails if has duplicate names", {
  expect_error(SetDynamicCovariates(clv.data = clv.data.apparel,
                                    data.cov.life = apparelDynCov, names.cov.life = c("High.Season", "Gender", "Channel"),
                                    data.cov.trans = apparelDynCov, names.cov.trans = c("High.Season", "Gender", "Channel", "Channel"),
                                    name.date = "Cov.Date"),

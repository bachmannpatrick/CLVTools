...
test_that("Warns for unneeded parameters", {
  expect_warning(plot(clv.cdnow, abc=123), regexp = "ignored")
  expect_warning(plot(clv.cdnow, transactions=TRUE), regexp = "ignored")
})

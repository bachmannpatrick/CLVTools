...
# floor.date -----------------------------------------------------------------------------------------------------
fct.testthat.correctness.clvtime.floor.date.rounds.down <- function(clv.t.days, clv.t.weeks, clv.t.years){
...
fct.testthat.correctness.clvtime.floor.date.stays.when.correct <- function(clv.t.days, clv.t.years){
  # **TODO: Hours**

...
// LL_i_single_walk
Rcpp::NumericVector LL_i_single_walk(const double r, const double alpha_0, const double s, const double beta_0, const double x, const double t_x, const double T_cal, const int num_walks, const double A1sum_R, const double B1, const double BT, const double DT, const double D1, const double F2_3, const arma::vec& params_life, const arma::vec& params_trans, const arma::mat& cov_data_life, const arma::mat& cov_data_trans, const arma::mat& walk_info_life, const arma::mat& walk_info_trans, const bool return_intermediate_results);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(LL_i_single_walk(r, alpha_0, s, beta_0, x, t_x, T_cal, num_walks, A1sum_R, B1, BT, DT, D1, F2_3, params_life, params_trans, cov_data_life, cov_data_trans, walk_info_life, walk_info_trans, return_intermediate_results));
    return rcpp_result_gen;
END_RCPP
}
// convert_walk
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CLVTools_LL_i_single_walk", (DL_FUNC) &_CLVTools_LL_i_single_walk, 21},

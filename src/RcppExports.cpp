...
// LL_i_single_walk
Rcpp::NumericVector LL_i_single_walk(const double r, const double alpha_0, const double s, const double beta_0, const double x, const double t_x, const double T_cal, const int num_walks, const double DT, const double F2_3, const arma::vec& params_life, const arma::vec& params_trans, const arma::mat& cov_data_life, const arma::mat& cov_data_trans, const arma::mat& walk_info_life, const arma::mat& walk_info_trans, const bool return_intermediate_results);
RcppExport SEXP _CLVTools_LL_i_single_walk(SEXP rSEXP, SEXP alpha_0SEXP, SEXP sSEXP, SEXP beta_0SEXP, SEXP xSEXP, SEXP t_xSEXP, SEXP T_calSEXP, SEXP num_walksSEXP, SEXP DTSEXP, SEXP F2_3SEXP, SEXP params_lifeSEXP, SEXP params_transSEXP, SEXP cov_data_lifeSEXP, SEXP cov_data_transSEXP, SEXP walk_info_lifeSEXP, SEXP walk_info_transSEXP, SEXP return_intermediate_resultsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const double >::type r(rSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(LL_i_single_walk(r, alpha_0, s, beta_0, x, t_x, T_cal, num_walks, DT, F2_3, params_life, params_trans, cov_data_life, cov_data_trans, walk_info_life, walk_info_trans, return_intermediate_results));
    return rcpp_result_gen;
END_RCPP
}
// convert_walk
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_CLVTools_LL_i_single_walk", (DL_FUNC) &_CLVTools_LL_i_single_walk, 17},

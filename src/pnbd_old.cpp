...
arma::vec old_pnbd_LL_ind(const double r,
                      const double s,
...
//' @rdname old_pnbd_LL
// [[Rcpp::export]]
arma::vec old_pnbd_nocov_LL_ind(const arma::vec& vLogparams,
                            const arma::vec& vX,
                            const arma::vec& vT_x,
                            const arma::vec& vT_cal){
  ...
  arma::vec vLL = old_pnbd_LL_ind(r, s, vAlpha_i, vBeta_i, vX, vT_x, vT_cal);
  return(vLL);
}
...
//' @rdname old_pnbd_LL
// [[Rcpp::export]]
double old_pnbd_nocov_LL_sum(const arma::vec& vLogparams,
                         const arma::vec& vX,
                         const arma::vec& vT_x,
                         const arma::vec& vT_cal){

  arma::vec vLL = old_pnbd_nocov_LL_ind(vLogparams,
                                    vX,
                                    vT_x,
                                    vT_cal);
...
//' @rdname old_pnbd_LL
// [[Rcpp::export]]
arma::vec old_pnbd_staticcov_LL_ind(const arma::vec& vParams,
                                const arma::vec& vX,
                                const arma::vec& vT_x,
                                const arma::vec& vT_cal,
...
//' @rdname old_pnbd_LL
// [[Rcpp::export]]
double old_pnbd_staticcov_LL_sum(const arma::vec& vParams,
                             const arma::vec& vX,
                             const arma::vec& vT_x,
                             const arma::vec& vT_cal,
                             const arma::mat& mCov_life,
  ...
  // Call and return summed values ----------------------------
    arma::vec vLL = old_pnbd_staticcov_LL_ind(vParams,
                                          vX,
                                          vT_x,
                                          vT_cal,
                                          mCov_life,

...
[![R build status](https://github.com/bachmannpatrick/CLVTools/workflows/R-CMD-check/badge.svg)](https://github.com/bachmannpatrick/CLVTools/actions)
...
The framework is capable to accomodate a variety of probabilistic customer attition models for non-contractual settings in continuous and discrete time.

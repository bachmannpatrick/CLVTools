...
#' @param reg.weights Named weights parameters (lambda) used for the L2 regularization of the lifetime and the transaction covariate parameters. Weights have to be >= 0.
